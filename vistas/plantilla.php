...
<head>
  ...
  <body>
    ...
    if (isset($_GET["pagina"])) {
      if ($_GET["pagina"] == "contenido-inicio" ||  $_GET["pagina"] == "contenido-cuerpo" ||$_GET["pagina"] == "contenido-consolidado" || $_GET["pagina"] == "contenido-terminacion" || $_GET["pagina"] == "contenido-lluvia" || $_GET["pagina"] == "salir") {
